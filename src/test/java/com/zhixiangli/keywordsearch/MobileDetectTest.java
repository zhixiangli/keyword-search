...
public class MobileDetectTest {
    ...
    public void testIsMobile() {
        final String[] userAgent = new String[]{"Mozilla/5.0 (Windows NT 6.1; rv:19.0) Gecko/20100101 Firefox/19.0",
        ...
        final boolean[] answer = new boolean[]{false, false, true, true, true};
        for (int i = 0; i < userAgent.length; ++i) {
            final boolean isMobile = MobileDetect.isMobile(userAgent[i]);
